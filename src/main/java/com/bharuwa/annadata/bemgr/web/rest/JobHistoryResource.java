...
import com.bharuwa.annadata.bemgr.repository.JobHistoryRepository;
import com.bharuwa.annadata.bemgr.service.JobHistoryService;
...
/**
 * REST controller for managing {@link com.bharuwa.annadata.bemgr.domain.JobHistory}.
 */
@RestController
@RequestMapping("/api")
public class JobHistoryResource {
    ...
    public ResponseEntity<JobHistory> partialUpdateJobHistory(
        ...
        return ResponseUtil.wrapOrNotFound(
            result,
            HeaderUtil.createEntityUpdateAlert(applicationName, true, ENTITY_NAME, jobHistory.getId())
        );
    }
