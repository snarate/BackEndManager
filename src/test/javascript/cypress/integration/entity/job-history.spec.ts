...
describe('JobHistory e2e test', () => {
  ...
  describe('new JobHistory page', () => {
    ...
    it('should create an instance of JobHistory', () => {
      cy.get(`[data-cy="startDate"]`).type('2022-04-17T12:26').should('have.value', '2022-04-17T12:26');

      cy.get(`[data-cy="endDate"]`).type('2022-04-17T02:35').should('have.value', '2022-04-17T02:35');
